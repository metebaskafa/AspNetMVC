...
namespace p013AspNetMVCEgitim.Controllers
{
    public class MVC09FileUploadController : Controller
    {
        ...
        [HttpPost]
        public IActionResult Index(IFormFile? Image) // ön yüzdeki file elementinin ismini buradaki IFormFile parametresine veriyoruz! IFormFile ? koymamızın sebebi post yapılırken kullanıcı resim yüklemeyebilir , sadece inputlardan veri göndermek isteyebilir.
        { 
